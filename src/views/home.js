        ...
        >
          ...
          <div data-thq="thq-navbar-nav" className="home-desktop-menu">
            <nav className="home-links">
              <span className="home-nav12">Каталог</span>
              <span className="home-nav22 bodySmall">Мастерская</span>
              <span className="home-nav32 bodySmall">Новости</span>
              <span className="home-nav42 bodySmall">Контакты</span>
            </nav>
          </div>
          ...
          >
            <div className="home-nav">
              ...
              <nav className="home-links1">
                ...
                <span className="home-nav221 bodySmall">Mosaics</span>
                <span className="home-nav321 bodySmall">Gallery</span>
